...
export function calculateLiuRen(calculation, options = {}) {
  ...
  const earthPlate = Array.from({ length: 12 }, (_, earthIndex) => {
    ...
    return { earth: branch(earthIndex), heaven: branch(heavenIndex), dunStem: dunStemForBranch(heavenIndex), heavenlyGeneral, heavenlyGeneralDetail: generalDetail(heavenlyGeneral), shenSha: shenSha.stars, shenShaGroups: shenSha.groups };
  });
  ...
  return {
    schemaVersion: "1.0.0",
    module: { name: "liu-ren", version: "0.3.0", responsibility: "消费公共核心并生成大六壬十二宫、四课、三传及旬遁干" },
