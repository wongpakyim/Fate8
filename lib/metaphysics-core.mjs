...
export function buildBranchShenSha(calculation) {
  ...
  const stemRules = [
    ...
    { name: "日医", targets: [[3], [11], [1], [7], [5], [3], [11], [1], [7], [5]][dayStem] },
    { name: "游都", targets: [[1], [0], [2], [5], [8], [1], [0], [2], [5], [8]][dayStem] },
  ];
  for (const rule of stemRules) for (const target of rule.targets) add("干煞", target, rule.name);
  const youDu = [1, 0, 2, 5, 8, 1, 0, 2, 5, 8][dayStem];
  add("干煞", youDu + 6, "鲁都");
